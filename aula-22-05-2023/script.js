function opa() {
  ...
  formulario.innerHTML +=
    '<label for="numero">Quantos alunos serão registrados?>';
  formulario.innerHTML +=
    '<input class="form-control" type="number" name="numero" id="numero">';
  formulario.innerHTML +=
    '<input type="button" class="btn btn-primary" value="oi" onclick="opa()"> <br>';
  ...
  formulario.innerHTML +=
    '<input class="btn btn-primary botoes" type="submit" value="enviar" >';
}
